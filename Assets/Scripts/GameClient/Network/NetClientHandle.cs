...
public class NetClientHandle
{
    ...
    public void GameInitPacketHandler(int clientId, long packetId, PacketType packetType, string message)
    {
    ...
    public void GameOverPacketHandler(int clientId, long packetId, PacketType packetType, string message)
    {
        netClient.netMessageQueue.PushMessage(new NetMessage(clientId, packetId, packetType, message));
    }
